...
* Reassign historical data for schools moving to ASD;
replace system = 985 if year == 2015 & system == 792 & school == 2150;
replace school = 8115 if year == 2015 & system == 985 & school == 2150;

replace system = 985 if year == 2015 & system == 792 & school == 2820;
replace school = 8105 if year == 2015 & system == 985 & school == 2820;

replace system = 985 if year == 2015 & system == 190 & school == 520 & grade == 5;
replace school = 8090 if year == 2015 & system == 985 & school == 520 & grade == 5;

replace system = 985 if year == 2015 & system == 792 & school == 2208;
replace school = 8120 if year == 2015 & system == 985 & school == 2208;

replace system = 985 if year == 2015 & system == 190 & school == 63 & grade == 8;
replace school = 8005 if year == 2015 & system == 985 & school == 63 & grade == 8;

replace system = 985 if year == 2015 & system == 792 & school == 2425 & (grade == 7 | grade == 8);
replace school = 8070 if year == 2015 & system == 985 & school == 2425 & (grade == 7 | grade == 8);

replace system = 985 if year == 2015 & system == 792 & school == 2765 & (grade == 3 | grade == 4 | grade == 5);
replace school = 8075 if year == 2015 & system == 985 & school == 2765 & (grade == 3 | grade == 4 | grade == 5);

replace system_name = "Achievement School District" if system == 985 & (school == 8115 | school == 8105 | school == 8090 | school == 8120 | school == 8005 | school == 8070 | school == 8075);
...
drop if residential_facility == 1;
...
* Collapse test proficiency by system, subject, and subgroup;
quietly foreach s in All Asian Black Hispanic Hawaiian Native White BHN ED SWD ELL ELL_T1_T2 Non_ED Non_SWD Non_ELL Non_ELL_T1_T2 Super {;
	...
	* All Grades;
	...
	collapse (sum) enrolled tested valid_test n_below_bsc n_bsc n_prof n_adv, by(year system original_subject subgroup);
	...
	* Individual Grades;
	...
	collapse (sum) enrolled tested valid_test n_below_bsc n_bsc n_prof n_adv, by(year system original_subject grade subgroup);
...
order year, first;
order subject grade subgroup, after(system);
...
foreach y in 2014 2015 2016 {;
	...
	keep year system subject grade subgroup enrolled tested valid_tests n_21_and_above pct_21_and_above n_below_19 pct_below_19;
...
foreach y in 2014 2015 2016 {;
	...
	use $grad/district_grad_rate`y'.dta, clear;
	...
	keep year system subject grade subgroup grad_cohort grad_count grad_rate dropout_count dropout_rate;
...
drop system_name school school_name pct_bsc_and_below;

tempfile 2014;
save `2014', replace;

* Append 2014 super subgroup from fall district preview;
use $fall_preview, clear;
...
* System 90 (Carroll County) does not appear in our accountability files;
drop if system == 90;
...
save "$output/system_base_with_super_subgroup_2016.dta", replace;
export delim using "$output/system_base_with_super_subgroup_2016.csv", delim(",") replace;
