...
student_level <- read_csv("N:/ORP_accountability/projects/2018_student_level_file/2018_student_level_file.csv",
    ...
    filter(grade %in% c(0, 3:12), residential_facility == 0, enrolled_50_pct_district == "Y") %>%
...
district_assessment <- assessment_2018 %>%
...
write_csv(district_assessment, "N:/ORP_accountability/data/2018_final_accountability_files/2018_district_assessment_file_50_pct.csv", na = "")
