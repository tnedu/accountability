...
ACT_substitution <- read_csv("N:/ORP_accountability/data/2016_ACT/system_act_substitution_2016.csv") %>%
    mutate(grade = as.character(grade)) %>%
...
ACT <- read_dta("N:/ORP_accountability/data/2015_ACT/ACT_district2016.dta") %>%
...
assessment_2016 <- bind_rows(district_assessment, ACT, ACT_substitution, grad) %>%
