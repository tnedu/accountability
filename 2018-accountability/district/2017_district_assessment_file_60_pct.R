...
student_level <- read_dta("N:/ORP_accountability/projects/2017_student_level_file/state_student_level_2017_JP_final_10192017.dta") %>%
    ...
    filter(grade %in% c(0, 3:12), greater_than_60_pct == "Y") %>%
...
# Output file
write_csv(assessment_2017, "N:/ORP_accountability/data/2018_final_accountability_files/2017_district_assessment_file_60_pct.csv", na = "")
