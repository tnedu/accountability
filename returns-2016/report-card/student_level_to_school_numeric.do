...
order year system school subject grade subgroup participation_rate enrolled enrolled_part_1_only enrolled_part_2_only enrolled_both 
...
export excel using "K:\ORP_accountability\projects\2016_state_results\For Report Card/school_numeric_2016_for_report_card.xlsx", firstrow(var) replace;
