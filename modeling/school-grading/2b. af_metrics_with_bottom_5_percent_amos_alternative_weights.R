...
AF_grades_metrics %<>%
    ...
    mutate(
        ...
        weight_postsecondary_readiness = ifelse(!is.na(grade_postsecondary_readiness) & subgroup == "All Students" & pool == "HS", 0.15, NA),
    ...
    mutate(total_weight = ifelse(pool == "K8", sum(c(weight_achievement, weight_growth, weight_opportunity, weight_maximizing_success, weight_ELPA), na.rm = TRUE), NA),
        total_weight = ifelse(pool == "HS", sum(c(weight_achievement, weight_growth, weight_opportunity, weight_maximizing_success, weight_postsecondary_readiness, weight_ELPA), na.rm = TRUE), total_weight),
