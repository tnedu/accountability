...
cdf <- read_fwf(file = "N:/Assessment_Data Returns/Grade 2_Regular and ALT/2017-18/2017-2018 TN Grade 2 Alt CDF Final Scores - 20180816.txt",
...
write_csv(cdf, path = "N:/ORP_accountability/data/2018_cdf/2018_grade_2_alt_cdf.csv", na = "")
