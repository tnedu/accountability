...
state_base <- read_csv("K:/ORP_accountability/data/2017_final_accountability_files/state_base_2017_sep26.csv",
...
write_csv(output, path = "K:/ORP_accountability/data/2017_final_accountability_files/state_numeric_2017_sep26.csv", na = "")
