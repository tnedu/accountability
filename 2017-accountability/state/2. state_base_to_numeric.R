...
state_base <- read_csv("N:/ORP_accountability/data/2017_final_accountability_files/state_base_2017_oct17.csv",
...
write_csv(output, path = "N:/ORP_accountability/data/2017_final_accountability_files/state_numeric_2017_oct17.csv", na = "")
