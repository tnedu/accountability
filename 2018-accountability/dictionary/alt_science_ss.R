...
cdf <- read_fwf(file = "N:/Assessment_Data Returns/TCAP ALT_Grades 3-11_Sci and SS/2017-18/2017-2018 TN 3-11 Alt CDF Final Scores - 20180816.txt",
...
write_csv(cdf, path = "N:/ORP_accountability/data/2018_cdf/2018_alt_science_ss_cdf.csv", na = "")
