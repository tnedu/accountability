...
district_grad <- read_dta("N:/ORP_accountability/data/2016_graduation_rate/District_grad_rate2017_JP.dta") %>%
...
write_csv(district_grad, path = "N:/ORP_accountability/projects/2018_amo/district_grad.csv", na = "")