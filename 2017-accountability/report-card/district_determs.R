...
determs <- haven::read_dta("K:/ORP_accountability/projects/2017_district_accountability/final_determinations_master_JW_10232017.dta") %>%
...
write_csv(determs, "K:/ORP_accountability/data/2017_final_accountability_files/Report Card/Accountability File Layout.csv", na = "")
