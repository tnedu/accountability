...
act_state <- read_dta("N:/ORP_accountability/data/2017_ACT/ACT_state2018_appeals.dta") %>%
    ...
    transmute(District_ID = 0, School_ID = 0, `Analysis Level` = "State", `District Name` = "",
        ...
        n_female_21_or_higher = female_n_21_orhigher, pct_female_21_or_higher = female_pct21orhigher,
        n_male_21_or_higher = male_n_21_orhigher, pct_male_21_or_higher = male_pct21orhigher,
        n_gender_missing_21_or_higher = nmissing_21_orhigher, pct_gender_missing_21_or_higher = 0, pct_gender_missing_below_19 = "")

act_district <- read_dta("N:/ORP_accountability/data/2017_ACT/ACT_district2018_appeals.dta") %>%
    filter(subgroup == "All Students") %>%
...
act_school <- read_dta("N:/ORP_accountability/data/2017_ACT/ACT_school2018_appeals.dta") %>%
    filter(subgroup == "All Students") %>%
...
write_csv(act_all, path = "N:/ORP_accountability/data/2017_final_accountability_files/Report Card/ACT_File_2016_17_dec15.csv")
